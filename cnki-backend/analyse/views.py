...
def doLogin(request):
    if request.method == "POST":
        print( request.POST.get("username"),' request.POST.get("name")')
        ...
        return HttpResponse( json.dumps({"status":500,"msg":'用户名或者密码错误'}))
